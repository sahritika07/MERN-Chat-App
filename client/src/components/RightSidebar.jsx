...
const RightSidebar = () => {
  ...
  return selectedUser && (
    <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll max-sm:px-3 max-sm:pt-10 ${selectedUser ? "max-md:hidden" : ""}`}>
      ...
      <div className="px-5 text-xs">
        <p>Media</p>
        <div className="mt-2 max-h-[200px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80 max-sm:grid-cols-1">
